...
function R(t, e, i, n) {
    ...
    t.forEach(function(t, r) {
        ...
        if (u.push(s), S(s).forEach(function(i) {
            ...
            var x = q(i.dataPointShape, e.dataPointShape), g = i.dataPointShape[x % i.dataPointShape.length];
            C(s, t.color, g, n);
        }
...
function q(t, e) {
    if (t) for (var i = 0; t.length >= 0; i++) if (t[i] === e) return i;
    return 0;
}
...
function B(t, e, i, n) {
    ...
    t.forEach(function(t, r) {
        ...
        if (d.push(s), S(s).forEach(function(i, a) {
            ...
            var u = q(i.dataPointShape, e.dataPointShape), x = i.dataPointShape[u % i.dataPointShape.length];
            C(s, t.color, x, n);
        }
    }), !1 !== e.dataLabel && 1 === a && t.forEach(function(t, o) {
        I(w(t.data, c, f, l, h, e, i, a), t, i, n);
...
function Q(t, e, i, n) {
    ...
    return b(s, l, h, t, e, a).forEach(function(t, a) {
        if (n.beginPath(), n.setFillStyle(t.color), n.setGlobalAlpha(.6), t.data.forEach(function(t, e) {
            ...
            var o = q(i.dataPointShape, e.dataPointShape), r = i.dataPointShape[o % i.dataPointShape.length];
...
at.prototype.updateData = function() {
    ...
    if ("line" === this.opts.type || "area" === this.opts.type) {
        ...
        if (n > -1) {
            ...
            if (0 === r.length) $.call(this, o.type, o, this.config, this.context); else {
        ...
        } else $.call(this, o.type, o, this.config, this.context);
    }
